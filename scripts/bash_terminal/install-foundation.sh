...
echo ""
warn "NEXT STEPS:"
log "1. Close this Terminal window"
log "2. Open iTerm2 (it should now be in your Applications folder)"
log "3. In iTerm2, navigate back to this project directory"
log "4. Run: ./scripts/bash_terminal/verify-foundation.sh"
log "5. Then run: ./scripts/zsh_terminal/install-apps.sh"
echo ""
info "The foundation (Homebrew, git, iTerm2, oh-my-zsh) is now ready!" 